...
QT_MOC_LITERAL(1, 8, 4), // "posx"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 4) // "posy"

    },
    "Plotter\0posx\0\0posy"
};
...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->posx((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->posy((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plotter::posx)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Plotter::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plotter::posy)) {
                *result = 1;
                return;
            }
        }
